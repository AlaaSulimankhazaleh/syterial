...
.controller('demoCtrl', ['$scope', function ($scope) {
  $scope.cssNav = {
    buttons: {url: 'css.buttons', name: 'Buttons'},
    cards: {url: 'css.cards', name: 'Cards'},
    forms: {url: 'css.forms', name: 'Forms'},
    icons: {url: 'css.icons', name: 'Icons'},
    tables: {url: 'css.tables', name: 'Tables'}
  };

  $scope.componentsNav = {
    tabs: {url: 'components.tabs', name: 'Tabs'}
  };
